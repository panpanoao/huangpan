...
<%--<ul id="list2"></ul>
  ...
  <aside class="l_box">
    ...
    <div class="links">
      <h2>友情链接</h2>
      <ul>
        <li><a href="http://www.yangqq.com" title="澈骨个人博客">澈骨个人博客</a></li>
      </ul>
    </div>
  </aside>
</article>
<div class="blank"></div>
<footer>
  <p>Design by <a href="http://www.yangqq.com" target="_blank">澈骨个人博客</a> <a href="/">木有备案</a></p>
</footer><a href="#" class="cd-top">Top</a>
</body>
</html>
